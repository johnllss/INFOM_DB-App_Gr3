...
CREATE TABLE payment (
	payment_id			BIGINT PRIMARY KEY AUTO_INCREMENT,
 	...
 	date_paid			DATETIME, -- null = not yet paid
  	...
  	discount_applied	DECIMAL(3,2) DEFAULT 0.0,
  	user_id				BIGINT,
  	cart_id				BIGINT,
...
DROP TRIGGER IF EXISTS update_items_price;
DROP TRIGGER IF EXISTS update_items_price_insert;
DROP TRIGGER IF EXISTS update_items_price_delete;
DROP TRIGGER IF EXISTS update_items_price_update;

DELIMITER //

CREATE TRIGGER update_items_price_insert
...
CREATE TRIGGER update_items_price_delete
...
END;
//
CREATE TRIGGER update_items_price_update
